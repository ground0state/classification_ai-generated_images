...
train_batch_size = 64
val_batch_size = 64
learning_rate = 0.0001 / train_batch_size
seed = 0
# ------------------------------------------
set_seed(0)
...
train_transforms = transforms.Compose([
    transforms.RandomAffine(degrees=10, translate=(0.0, 0.1), scale=(1.0, 1.0)),
    transforms.RandomResizedCrop(224),
    transforms.RandomHorizontalFlip(),
    transforms.ColorJitter(brightness=0.1, contrast=0, saturation=0.1, hue=0.1),
    transforms.ToTensor(),
