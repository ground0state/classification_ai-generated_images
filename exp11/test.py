...
def parse_arguments():
    ...
    parser.add_argument('--image_sub_dir', type=str, required=True, help='Sub directory for images')
    parser.add_argument('--suffix', type=str, default='', help='Suffix for the save filename')
...
if __name__ == "__main__":
    ...
    checkpoint_path = join(c.work_dirs, c.exp, f"checkpoint_epoch_{c.test_epoch}.pth")
